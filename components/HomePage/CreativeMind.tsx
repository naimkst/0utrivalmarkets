...
import BrilinatDot from "../../public/images/Brilinat-dot.png";
          ...
          <div className="grid grid-cols-5 justify-between items-center">
            <div className="col-span-3">
              ...
              <p className="sectionDescriptionBigLine">
                ...
                your questions comments concerns <br/> and anxieties (oh no, we are
                not therapists, but if it's anything <br/>marketing... We can surely
                help out!
              </p>
              <button className="bg-gradient-to-r from-[#FF9127] to-[#F45356] py-[18px] px-[45px] text-white font-bold text-[24px] rounded-[7px] mt-8 hover:from-[#F45356] hover:to-[#FF9127]" >Send us a message</button>
            </div>
