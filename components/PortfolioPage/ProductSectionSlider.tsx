            ...
            <div className="productSlider">
              ...
              >
                <SwiperSlide className="py-[40px] md:py-[90px] overflow-x-hidden overflow-y-hidden">
                  <div className="bg-[#DBDBDB] py-[60px] md:px-[60px] px-5">
                    <div>
                      <div>
                        <h2 className="text-[38px] text-[#090D48] font-bold">
                          Amazon Listings{" "}
                        </h2>
                        <p className="text-[20px] leading-[30px] md:text-[#303030] !text-[#303030]">
                      ...
                      <div className="mt-10">
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-4 items-center">
                          ...
                          <div>
                            <h2 className="md:text-[35px] text-[30px] font-bold text-[#090D48]">
                              ...
                              <ul>
                                <li>
                                  <p className="flex items-center mb-3">
                                    ...
                                    <span className="text-[22px] leading-[36px] font-semibold ml-3 !text-[#303030]">
                            ...
                            <div>
                              <div className="flex items-center ">
                                <p className="text-[24px] text-[#303030] font-semibold mr-3 !text-[#303030]">
                                  Color:{" "}
                                </p>
                              ...
                              <ul>
                                <li>
                                  <p className="flex items-center mb-3">
                                    ...
                                    <span className="text-[22px] leading-[36px] font-semibold ml-3 !text-[#090D48]">
                                      Adjuestabe construction belt system{" "}
                                    </span>
                                  </p>
                                </li>
